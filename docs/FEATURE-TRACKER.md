...
| HamClock Wall (2026-09-05)              | 27        | 4       | 24          | 0        | 55      |
| **Grand Total**                         | **291**   | **11**  | **32**      | **1**    | **335** |
...
| HW-24 | Desk on wall tiles, paged, scale token                        | PR #TBD, `--hc-scale` in `hamclock-wall.css`, `HamClockWall` at both densities                                 |
| HW-25 | Desk cleanup: DE station block, duplicate weather, DX target  | PR #TBD, `HamClockSidebar.tsx`/`HamClockLocationConditions.tsx` deleted, `DxTargetTile`/`DxTargetReport` added |
