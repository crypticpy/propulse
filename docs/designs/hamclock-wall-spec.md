...
| HW-59 | Propagation forecast report: 48 h band chart, matrix tab, FutureCast horizons tab           | Delivered |                                       | PR #502, effective on merge; [evidence](hamclock-propagation-forecast-report.md)                                                                                                                                                                                                                                                                                                             |
