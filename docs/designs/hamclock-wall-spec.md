...
| HW-59 | Propagation forecast report: 48 h band chart, matrix tab, FutureCast horizons tab           | Partial |                                       | PR #502; future scorer/response contract unavailable; [evidence](hamclock-propagation-forecast-report.md)                                                                                                                                                                                                                                                                                                             |
