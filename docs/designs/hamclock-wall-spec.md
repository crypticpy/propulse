...
| HW-58 | Reliability report: SNR, confidence, station inputs, three-engine chart                     | Partial |                                       | section 26.3; dedicated report implemented in B18 Reliability slice; source history and hop count gaps documented in [evidence](hamclock-reliability-report.md)                                                                                                                                                                                                                                                                                                             |
| HW-59 | Propagation forecast report: 48 h band chart, matrix tab, FutureCast horizons tab           | Delivered |                                       | B18 Forecast review slice, effective on merge; [evidence](hamclock-propagation-forecast-report.md)                                                                                                                                                                                                                                                                                                             |
...
Totals: 46 delivered, 3 partial, 24 not started.
