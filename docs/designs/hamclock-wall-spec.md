...
| HW-65 | EME computation module `src/lib/utils/eme.ts`                                               | Delivered   | PR #253                               | `src/lib/utils/eme.ts` + tests: path loss, degradation vs perigee, declination word, galactic-latitude sky noise, topocentric Doppler, mutual moon window                                                                                                                                                                |
| HW-66 | Moon and EME report                                                                         | Delivered   | PR #253                               | section 26.10; `MoonReport.tsx`, MOON / EME tabs, band selector, 24 h elevation + 28-day degradation charts, sub-lunar map link; `SunMoonReport` retired                                                                                                                                                                 |
