...
| HW-21 | Layer registry with provenance text                                                         | Delivered   | PR (B6)                               | feeds settings, help; no distinct wall status line component exists to feed (see B6 report)                                                                                                                                                                         |
...
| HW-39 | Map style chooser on the Map tab                                                            | Delivered   | PR (B6)                               | section 14                                                                                                                                                                                                                                                          |
...
| HW-55 | Persist a tile provider id in `mapStore` so Esri / Mapbox and OSM / CARTO become selectable | Delivered   | PR (B6)                               | migration derives it from `mapStyle` + tier; section 14                                                                                                                                                                                                             |

Totals: 25 delivered, 4 partial, 26 not started.
