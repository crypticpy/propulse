...
| HW-47 | Monitored regions and RIM scores as a report                                                | Delivered   | this PR                               | `RimReport` REGIONS tab; selecting a region re-scopes lightning, TEC and NVIS. HW-47 moved here from B16.                                                                                                                                                                                                              |
...
| HW-69 | Radio Impact Model tile                                                                     | Delivered   | this PR                               | `RimTile` on the Weather page over `computeRIM` / `useRIM`; section 26.13; unavailable sub-scores dropped from the composite                                                                                                                                                                                              |
