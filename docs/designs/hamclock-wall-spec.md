...
| HW-20 | Auto-page dwell mode                                                                        | Delivered   | PR #236                               | `useWallAutoPage.ts`, `HamClockPager.tsx` AUTO toggle, `DisplayTab.tsx` AUTO-PAGE row                                                                                                                                                                               |
...
Totals: 26 delivered, 4 partial, 25 not started.
