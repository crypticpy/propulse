...
> The latest preserved receipt window is only `10/720` hours and
...
> `warming` at `2.00/24` preflight hours, so these results do not authorize prospective or learned-
