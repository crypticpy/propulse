...
> The latest preserved receipt window is only `9/720` hours and
...
> `warming` at `1.14/24` preflight hours, so these results do not authorize prospective or learned-
