    ...
    <>
      <div className="absolute bottom-4 right-4 z-10 flex flex-col gap-2">
        <button
          ...
          className="px-3 py-1.5 rounded-full text-[11px] font-mono font-bold tracking-wide bg-deep-space/80 text-su-text/90 hover:text-su-text border border-su-line/40 hover:border-plasma-orange/40 backdrop-blur-sm transition-colors"
        >
          SitRep
        </button>
        ...
        <button
          ...
          className="px-3 py-1.5 rounded-full text-[11px] font-mono font-bold tracking-wide bg-alert-red/20 text-su-text hover:bg-alert-red/20 border border-alert-red/30 backdrop-blur-sm transition-colors"
