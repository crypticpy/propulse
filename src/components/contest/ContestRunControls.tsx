...
export function ContestRunControls({
  ...
  return (
    <div className="flex items-center gap-2">
      {/* Run / S&P mode */}
      <div className="flex items-center bg-su-input border border-su-line/40 rounded-lg p-1">
        <button
          type="button"
      ...
      <select
        ...
        className="px-2 py-1 rounded-lg bg-su-input border border-su-line/40 text-cosmic-cyan font-mono text-xs focus:outline-none cursor-pointer disabled:cursor-not-allowed disabled:opacity-60"
      ...
      <select
        ...
        className="px-2 py-1 rounded-lg bg-su-input border border-su-line/40 text-su-text font-mono text-xs focus:outline-none cursor-pointer disabled:cursor-not-allowed disabled:opacity-60"
      ...
      <button
        ...
        className="px-2 py-1 rounded-lg bg-su-line/10 border border-su-line/40 text-su-muted hover:text-su-text hover:bg-su-line/20 transition-colors text-xs"
