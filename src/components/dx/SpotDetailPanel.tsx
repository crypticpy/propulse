      ...
      <div className="flex flex-wrap items-center gap-2 mb-1">
        {entity ? (
          <>
            ...
            <span className="text-xs text-su-muted font-mono inline-flex items-center gap-0.5">
        ...
        {continentCode && (
          <span
            className={`px-1.5 py-0.5 rounded-full text-xs font-bold leading-none ${continentStyle.bg} ${continentStyle.text}`}
          >
            {continentCode}
          </span>
        )}
      ...
      <div className="flex items-start gap-6">
        ...
        <div className="flex flex-col gap-0.5">
          ...
          {pathMetrics ? (
            ...
            <span className="text-xs text-su-muted font-mono">--</span>
          )}
        </div>
        ...
        <div className="flex flex-col gap-0.5">
          ...
          {spot.dxGrid && (
            <div className="flex items-center gap-1">
              <span className="text-xs text-su-muted uppercase inline-flex items-center gap-0.5">
          ...
          {spot.mode && (
            <div className="flex items-center gap-1">
              <span className="text-xs text-su-muted uppercase">Mode</span>
              <span className="text-xs text-su-text font-mono">
                {spot.mode}
              </span>
            </div>
        ...
        {spot.comment && (
          <div className="flex flex-col gap-0.5 min-w-0 flex-1">
            ...
            <span className="text-xs text-su-text font-mono break-words">
              {spot.comment}
            </span>
          </div>
        )}
