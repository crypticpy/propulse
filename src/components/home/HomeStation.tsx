...
export function HomeStation() {
  ...
  return <section aria-label="Your station" className="home-panel home-station">
    <div className="flex items-center justify-between gap-2"><h2 className="font-orbitron text-sm text-su-text">Your station</h2><Link to="/shack" className="inline-flex min-h-11 items-center text-xs text-su-info">Manage setup →</Link></div>
