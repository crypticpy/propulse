      ...
      <>
        <div
          ...
          className="fixed bg-su-panel/90 backdrop-blur-md border border-su-line/50 rounded-full shadow-lg
                     hover:bg-su-panel/95 transition-all duration-150 px-3 py-1.5 flex items-center gap-2 select-none"
          style={{
            left: layout.x,
            top: layout.y,
            zIndex: zIndex ?? "auto",
    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Title */}
          <span className="flex-1 text-xs font-medium text-su-text/80 truncate select-none">
            {title}
          </span>
