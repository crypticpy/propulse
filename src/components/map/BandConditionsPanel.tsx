      ...
      <td className="px-1 py-1">
        ...
        */}
        <div className="flex flex-wrap items-center gap-1.5">
          ...
          {isGreylineActive && (
            <span
              className="px-1 py-0.5 rounded text-xs font-medium bg-amber-500/20 text-amber-400"
          ...
          {esDetection?.active && (
            <span
              className="px-1 py-0.5 rounded text-xs font-semibold bg-purple-500/20 text-purple-400"
          ...
          {hasBandOpening && (
            <span
              className="px-1 py-0.5 rounded text-xs font-semibold bg-signal-green/20 text-signal-green"
