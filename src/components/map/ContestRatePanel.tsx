...
export function ContestRatePanel({ className }: ContestRatePanelProps) {
  ...
  if (collapsed) {
    return (
      <button
        ...
        role="status"
      >
        <span className="text-xs uppercase tracking-wider text-su-text/80 font-semibold">
          RATE
        </span>
  ...
  return (
    ...
    >
      ...
      {sortedBands.length > 0 && (
        <>
          ...
          <div className="px-3 py-2">
            <div className="text-xs uppercase tracking-wider text-su-text/80 font-medium mb-1.5">
              Rate by Band
            </div>
              ...
              {sortedBands.map(([band, rate]) => {
                ...
                return (
                  <div key={band} className="flex items-center gap-2">
                    <span className="text-xs text-su-text/80 w-8 text-right shrink-0 tabular-nums">
                      {band}
                    </span>
                    ...
                    <span className="text-xs text-su-text/80 w-6 text-right shrink-0 tabular-nums">
                      {rate}
                    </span>
                  </div>
                );
      ...
      {/* ── Score summary ── */}
      <div className="border-t border-su-line/20" />
      <div className="px-3 py-2 flex items-center justify-between text-xs text-su-text/80">
