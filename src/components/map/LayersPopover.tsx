  ...
  const renderDisplaySubmenu = () => (
    <div className="space-y-0.5">
      ...
      {labelOptions.gridLabels && (
        <>
          <div className="flex flex-wrap items-center min-h-7 px-1 mt-1">
            ...
            />
            <span className="text-xs font-mono text-su-text/80 min-w-14 whitespace-nowrap text-right shrink-0 tabular-nums">
              {gridLabelDetail === 1
                ? "Field"
                : gridLabelDetail === 2
                  ? "Square"
      ...
      <div className="flex flex-wrap items-center min-h-7 px-1">
        ...
        />
        <span className="text-xs font-mono text-su-text/80 min-w-9 whitespace-nowrap text-right shrink-0 tabular-nums">
          ...
          >
            <div className="flex bg-[#0c0e18]/[0.96] backdrop-blur-xl border border-su-line/20 rounded-xl shadow-2xl shadow-black/60 overflow-hidden">
              ...
              {/* ── Submenu panel ──
                  ...
                  track instead of an undraggable sliver. Placement already
                  clamps to the viewport (HW-23), so the wider xl box still
                  fits phone, tablet, workstation, and wall. */}
              <div
                data-layers-submenu=""
                className="w-[14.5rem] min-h-[180px] max-h-[70vh] overflow-y-auto py-2 px-2.5"
              >
                {/* Category header */}
