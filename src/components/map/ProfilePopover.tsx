...
export function ProfilePopover({
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {/* ── Popover panel ── */}
      <div
        className={`absolute top-full left-0 mt-1.5 w-[300px] z-50 bg-void-black/90 backdrop-blur-md border border-white/10 rounded-xl shadow-xl p-3 max-h-[70vh] overflow-y-auto transition-all duration-150 ${
          open
