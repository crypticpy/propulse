import { recentContactsConfigSchema, RECENT_CONTACTS_CONFIG_DEFAULTS, type RecentContactsConfig } from "@/lib/hamclock/widgetSchemas";
export { recentContactsConfigSchema, RECENT_CONTACTS_CONFIG_DEFAULTS, type RecentContactsConfig } from "@/lib/hamclock/widgetSchemas";
