...
export function HeatMapReport({
  ...
  const { regionalCells, available, unavailableLabel, basisLabel, baselineAgeLabel, hourUtc } = useHeatMapBaseline();
  ...
  const facts: WallReportFact[] = [
    ...
    { label: "BASELINE", value: unavailableLabel ?? baselineAgeLabel },
  ];
