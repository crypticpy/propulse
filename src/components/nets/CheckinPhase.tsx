...
export function CheckinPhase({
  ...
  return (
    <div className="flex flex-col flex-1 min-h-0 gap-4 animate-in fade-in">
      ...
      <div className="shrink-0 flex items-center justify-between bg-su-line/10 border border-su-line/50 rounded-xl px-3 py-2">
        ...
        <button
          ...
          className={`
            ...
            ${
              hasCheckins
                ? "bg-plasma-orange text-su-on-accent shadow-lg shadow-plasma-orange/20 hover:bg-plasma-orange/90 hover:brightness-110 hover:shadow-[0_0_16px_rgba(255,107,53,0.3)] active:scale-[0.98] will-change-transform animate-pulse-glow"
                : "bg-su-line/10 text-su-muted border border-su-line/50 cursor-not-allowed"
            }
          `}
      ...
      <div className="flex-1 min-h-0 overflow-y-auto bg-su-line/10 backdrop-blur-sm border border-su-line/50 rounded-2xl p-3">
        <CheckinList
          checkins={checkins}
