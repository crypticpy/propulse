...
function AlertToast({
  ...
  return (
    <div
      className="flex items-start gap-3 px-4 py-3 bg-plasma-orange/20 backdrop-blur-md border border-plasma-orange/50 border-l-4 border-l-plasma-orange rounded-xl shadow-lg shadow-black/30 ring-1 ring-plasma-orange/25 max-w-xs animate-fade-in"
      role="alert"
      aria-live="assertive"
    >
      {/* Radio icon */}
