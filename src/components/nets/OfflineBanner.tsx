...
const OfflineBanner: FC<OfflineBannerProps> = ({ pendingCount }) => {
  return (
    <div
      role="status"
      aria-live="polite"
      className="fixed top-0 left-0 right-0 z-50 bg-su-panel border-b border-caution-amber/30 transition-opacity duration-300"
    >
      <div className="bg-caution-amber/20 px-4 py-2">
