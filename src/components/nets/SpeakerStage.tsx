...
export function SpeakerStage({
    ...
    return (
      ...
      >
        ...
        <div className="animate-pulse">
          <svg
            className="w-20 h-20 text-signal-green drop-shadow-[0_0_20px_rgba(34,197,94,0.4)]"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
            aria-hidden="true"
        ...
        <p className="text-2xl font-bold text-signal-green tracking-wide">
  ...
  return (
    ...
    >
      ...
      <div
        className="bg-white/[0.02] border border-white/5 rounded-2xl p-6 flex flex-col items-center gap-4"
        style={{
          boxShadow:
            "0 0 40px rgba(255,255,255,0.02), inset 0 1px 0 rgba(255,255,255,0.04)",
        }}
      >
        {/* ── NOW SPEAKING pill badge ── */}
        <span className="inline-flex items-center gap-1.5 bg-plasma-orange/10 text-plasma-orange border border-plasma-orange/20 rounded-full px-3 py-0.5 text-[10px] font-bold uppercase tracking-widest">
          <span
        ...
        <div className="flex items-center gap-3 w-full max-w-md">
          ...
          <button
            ...
            disabled={!hasSpeaker}
            data-skip-station
            className="flex-1 px-4 py-2 text-sm font-medium rounded-xl border transition-colors bg-amber-500/10 text-amber-400 border-amber-500/20 hover:bg-amber-500/25 disabled:opacity-40 disabled:cursor-not-allowed"
          ...
          <button
            ...
            disabled={!hasSpeaker}
            data-advance-queue
            className="flex-[2] px-5 py-3 text-base font-bold rounded-xl border-2 transition-all bg-green-500/20 text-green-300 border-green-500/30 hover:bg-green-500/30 hover:border-green-400/40 hover:shadow-[0_0_20px_rgba(34,197,94,0.15)] disabled:opacity-40 disabled:cursor-not-allowed"
          ...
          <button
            onClick={onNoShow}
            disabled={!hasSpeaker}
            className="flex-1 px-4 py-2 text-sm font-medium rounded-xl border transition-colors bg-red-500/10 text-red-400 border-red-500/20 hover:bg-red-500/25 disabled:opacity-40 disabled:cursor-not-allowed"
        ...
        <div className="w-full border-t border-white/5 mt-1 pt-3 flex items-center justify-between px-1">
