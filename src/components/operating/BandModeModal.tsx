...
export function BandModeModal(props: BandModeModalProps) {
  ...
  return <Suspense fallback={<p role="status" className="fixed bottom-4 right-4 z-50 rounded-lg bg-panel p-3 text-sm text-su-text">Loading band controls…</p>}><Content {...props} /></Suspense>;
}
