 ...
 *
 * SECURITY INVARIANT: escapeHtml() MUST run before any markdown transforms.
 * This ensures user-supplied text never contains raw HTML. All HTML tags in the
 * output are generated by renderInline() from markdown syntax on pre-escaped text.
 * Link URLs are validated by isSafeUrl() to only allow http/https/mailto protocols.
 * Any new markdown transform added here must NOT introduce raw user content into HTML.
 */
