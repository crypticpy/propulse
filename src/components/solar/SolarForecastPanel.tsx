            ...
            {resources.forecast.data && (
              <div className="grid gap-3 sm:grid-cols-3">
                {resources.forecast.data.forecast.map((day) => <article key={day.date} className="rounded-xl border border-su-line/40 bg-su-panel/70 p-4">
                  ...
                  <p className="mt-3 text-xs text-su-muted">Predicted SFI <strong className="block font-mono text-xl text-su-info">{day.predicted_flux} sfu</strong></p>
                  <p className="mt-2 text-xs text-su-muted">Predicted planetary A <strong className="font-mono text-base text-su-warning">{day.predicted_planetary_a}</strong></p>
