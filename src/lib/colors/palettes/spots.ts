...
// Authority for general spot colors and resolvers; context variants stay named.
...
export function getBandColor(bandOrFreq: string | number): string {
  ...
  // Inherited object keys are unknown bands, never CSS colors.
  return Object.prototype.hasOwnProperty.call(BAND_COLORS, normalized)
    ? BAND_COLORS[normalized]
    : BAND_COLORS.default;
}
...
/** FT8 HUD identity colors; deliberately distinct from general spot bands. */
export const FT8_HUD_BAND_COLORS: Record<string, string> = {
  "160m": "#ff6b6b",
  "80m": "#e8596e",
  "60m": "#d4507a",
  "40m": "#f59e0b",
...
/** Case-sensitive HUD bands retain their own unknown color. */
export function getFt8HudBandColor(band: string | null): string {
  return band && Object.prototype.hasOwnProperty.call(FT8_HUD_BAND_COLORS, band)
    ? FT8_HUD_BAND_COLORS[band]
    : "#9ca3af";
}
